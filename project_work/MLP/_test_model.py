...
# data_mean = torch.tensor([-1.8200,   1.3300]).float()
...
model1.load_state_dict(torch.load('20_trained_model.pth'))
if test_second:
...
while True:
    ...
    if coordinateStore1.new:
        ...
        inp = torch.tensor([coordinateStore1.point[0], coordinateStore1.point[1]]).float()
        inp -= data_mean
